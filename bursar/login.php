...
<body>
    ...
    <button class="btn btn-lg btn-primary btn-block" onclick="window.location.href='http://localhost/GMS/index.php'" ><h2 align="center" style="color:white;">HOME</h2></button>
